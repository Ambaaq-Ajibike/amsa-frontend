...
import { columns } from '@/features/members/components/users-columns'
import { UsersDialogs } from '@/features/members/components/users-dialogs'
import { UsersPrimaryButtons } from '@/features/members/components/users-primary-buttons'
import { UsersTable } from '@/features/members/components/users-table'
import UsersProvider from '@/features/members/context/users-context'
import { userListSchema } from '@/features/members/data/schema'
import { users } from '@/features/members/data/users'
      ...
      <div className='m-auto flex h-full w-full flex-col items-center justify-center gap-2'>
        ...
        <div className='mt-6 flex gap-4'>
          ...
          <Button onClick={() => navigate({ to: '/clerk/sign-in' })}>
            <img src='/images/amsa-logo.png' alt='AMSA Nigeria' className='invert inline-block align-middle h-6 w-6 mr-2' /> Sign in
          </Button>
        </div>
